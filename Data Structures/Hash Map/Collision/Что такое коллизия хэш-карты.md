...
<div style="display: flex; align-items: flex-start;">
	<ul style="list-style-type: none; margin: 0; padding: 0; text-align: center; flex-grow: 1;">
		...
		<li><strong><a href="obsidian://open?file=Data Structures/Hash Map/Collision/Что происходит при коллизии хэш-карты">Что происходит при коллизии хэш-карты</a></strong></li>
	</ul>
</div>
<h2 align="left">Тэги</h2>
#datastructure #hashmap #hashtable #bucket #collision